...
"border-radius: 8px;")
        ...
        self.gridLayout.addWidget(self.graphics_widget, 2, 1, 3, 1)
        ...
        self.gridLayout.addWidget(self.calculate_push_button, 4, 0, 1, 1)
        self.parameters_layout = QtWidgets.QVBoxLayout()
        self.parameters_layout.setObjectName("parameters_layout")
        self.gridLayout.addLayout(self.parameters_layout, 3, 0, 1, 1)
